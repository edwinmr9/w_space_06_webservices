...
public class PersonasController {
	...
	@PostMapping(value="lista/{parametro}",consumes=MediaType.APPLICATION_JSON_VALUE)
	public void agregarPersona(@RequestBody Persona p, @PathVariable("parametro") String cad) {
		personas.add(p);
		System.out.println("============ PARAMETRO POR @POSTMPPING: "+ cad);
	}
